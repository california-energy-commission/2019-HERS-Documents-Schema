        ...
        for restriction in restrictions:
            ...
            for enumeration in enumerations:
                ...
                if base == 'dtyp':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/DataTypes.xsd).".format(basePath, value, type))
                        hasError = True
                ...
                if base == 'bld':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/ResBuilding.xsd).".format(basePath, value, type))
                        hasError = True
                ...
                if base == 'com':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/ResCommon.xsd).".format(basePath, value, type))
                        hasError = True
                ...
                if base == 'comp':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/ResCompliance.xsd).".format(basePath, value, type))
                        hasError = True
                ...
                if base == 'env':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/ResHvac.xsd).".format(basePath, value, type))
                        hasError = True
                ...
                if base == 'lit':
                    ...
                    if len(query) == 0:
                        print("{} - Enumeration value '{}' is not in the value space of the base type {} (base/ResLighting.xsd).".format(basePath, value, type))
                        hasError = True
