...
base = ElementTree.parse('../deployed/base/ResCompliance.xsd').getroot()
tag_dict = {
    ...
    try:
        ...
        for key, value in tag_dict.items():
            ...
            for tag in tags:
                ...
                enum = base.find("./*[@name='ComplianceDocumentTag'].//xsd:enumeration[@value='{}']".format(tag_value), namespace)
